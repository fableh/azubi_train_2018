...
config_broker='sycor.eu10.cp.iot.sap'

config_credentials_key='./credentials.key'
config_credentials_crt='./credentials.crt'
config_crt_4_landscape='./eu10cpiotsap.crt'

config_alternate_id_device='<YOUR_DEVICE_ID>'
config_alternate_id_capability='047eb5587b117f8f'
config_alternate_id_sensor='<YOUR_SENSOR_ID>'
...
client.tls_set(ca_certs=config_crt_4_landscape ,certfile=config_credentials_crt,  keyfile=config_credentials_key)
